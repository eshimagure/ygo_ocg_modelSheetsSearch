...
root.render(
    <div className={styles.outer} id={"top"}>
        {/* ////////// ヘッダー部分 ////////// */}
        <h1>遊戯王OCGモンスター設定画検索</h1>
        <p style={{fontSize:"0.8em"}}>
            ※画像クリックで別窓表示されます。<br/>
            ※公式Xのpostからデータを引用しているため、元postが削除された場合こちらのデータも消えます。<br/>
            ※こちらは継続的な保守・更新予定はありません（最終更新2026/08/15）。コードを<a href='https://github.com/eshimagure/ygo_ocg_modelSheetsSearch'>GitHub</a>に公開しているので保守・更新したい方はクローンして下さい。
        </p>
