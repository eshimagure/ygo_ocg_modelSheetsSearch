                ...
                <div className={styles.categoryFilter}>
                   <label>
                    ...
                    <label>
                        ...
                        name="category" 
                        value="国内アカウント" 
                        checked={categoryFilter === '国内アカウント'} 
                        onChange={(e) => setCategoryFilter(e.target.value)} 
                        className={styles.visuallyHidden} />
                        <span className={`${styles.filterButton} ${categoryFilter === '国内アカウント' ? styles.activeFilter : ''}`}>国内アカウントのみ</span>
                    </label>
                    <label>
                        <input 
                        type="radio" 
                        name="category" 
                        value="海外アカウント" 
                        checked={categoryFilter === '海外アカウント'} 
                        onChange={(e) => setCategoryFilter(e.target.value)} 
                        className={styles.visuallyHidden} />
                        <span className={`${styles.filterButton} ${categoryFilter === '海外アカウント' ? styles.activeFilter : ''}`}>海外アカウントのみ</span>
                    </label>
                </div>
            </div>
